...
## 2. Project License
- The project contains both MIT-licensed code (from Next Saas Stripe Starter) and original code by the Maintainer
released under the CC BY-NC license.
- By contributing, you agree that your contribution is published under the same CC BY-NC license
as the Maintainer’s original code.
